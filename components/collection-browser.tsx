...
const collectionLayouts: Record<string, CollectionLayout> = {
  original: {
    hero: {
      ...
      front: {
        productId: "aja",
        src: "/brand/products/original/aja/aja-front.png",
        alt: "AJA Heritage Collection full outfit",
        className: "object-cover object-top"
      },
      hover: {
        productId: "aja",
        src: "/brand/products/original/aja/aja-side.png",
        alt: "AJA Heritage Collection side view",
        className: "object-cover object-top"
      }
    },
    grid: [
      ...
      {
        productId: "ijeoma",
        src: "/brand/products/original/ijeoma/ijeoma-detail.png",
        alt: "IJEỌMA Heritage Collection detail"
      },
      {
        productId: "nsuo",
        src: "/brand/products/original/nsuo/nsuo-lifestyle.png",
        alt: "NSỤO Heritage Collection lifestyle image"
      },
      {
        productId: "ebube",
        src: "/brand/products/original/ebube/ebube-mid.png",
        alt: "EBUBE Heritage Collection upper-body view"
      }
    ]
  },
  "with-button": {
    hero: {
      ...
      front: {
        productId: "ndb2",
        src: "/brand/products/button/ndb2/ndb2-front.png",
        alt: "NDB2 Cowrie Collection full outfit",
        className: "object-cover object-top"
      },
      hover: {
        productId: "ndb2",
        src: "/brand/products/button/ndb2/ndb2-angle.png",
        alt: "NDB2 Cowrie Collection angled view",
        className: "object-cover object-top"
      }
    },
    grid: [
      {
        productId: "ndb4",
        src: "/brand/products/button/ndb4/ndb4-mid.png",
        alt: "NDB4 Cowrie Collection upper-body view"
      },
      {
        productId: "ndb2",
        src: "/brand/products/button/ndb2/nd2-detail.png",
        alt: "NDB2 Cowrie Collection detail"
      },
      {
        productId: "ndb5",
        src: "/brand/products/button/ndb5/nd5-lifestyle.png",
        alt: "NDB5 Cowrie Collection lifestyle image"
      },
      {
        productId: "ndb1",
        src: "/brand/products/button/ndb1/ndb1-angle.png",
        alt: "NDB1 Cowrie Collection angled view"
      }
    ]
  },
  "without-button": {
    hero: {
      ...
      front: {
        productId: "nd3",
        src: "/brand/products/buttonless/nd3/nd3-angle.png",
        alt: "ND3 Resort Collection angled outfit",
        className: "object-cover object-top"
      },
      hover: {
        productId: "nd3",
        src: "/brand/products/buttonless/nd3/nd3-back.png",
        alt: "ND3 Resort Collection back view",
        className: "object-cover object-top"
      }
    },
    grid: [
      {
        productId: "nd4",
        src: "/brand/products/buttonless/nd4/nd4-mid.png",
        alt: "ND4 Resort Collection upper-body view"
      },
      {
        productId: "nd3",
        src: "/brand/products/buttonless/nd3/nd3-detail.png",
        alt: "ND3 Resort Collection detail"
      },
      {
        productId: "nd1",
        src: "/brand/products/buttonless/nd1/nd1-lifestyle.png",
        alt: "ND1 Resort Collection lifestyle image"
      },
      {
        productId: "nd2",
    ...
    <>
      <div className="relative aspect-[4/5] overflow-hidden bg-[#f1f0ec]">
        <Image
          ...
          priority={priority}
          quality={94}
          sizes="(min-width: 1024px) 390px, (min-width: 768px) 36vw, 88vw"
      ...
      <div className="pt-4">
        <p className="text-sm font-semibold text-copy md:text-base">{section.title}</p>
        <ProductPrice className="mt-2 block text-xl font-bold leading-none text-copy md:text-2xl" />
          ...
          const image = (
            <div className="relative aspect-[4/5] overflow-hidden bg-[#f1f0ec]">
              <Image
                ...
                quality={93}
                sizes="(min-width: 1024px) 250px, (min-width: 768px) 22vw, 45vw"
...
export function CollectionBrowser({ sections }: { sections: CollectionSection[] }) {
  return (
    <div id="collections" className="overflow-hidden">
      {sections.map((section, sectionIndex) => {
        const layout = collectionLayouts[section.id];
        if (!layout) return null;
        const monogramPosition = sectionIndex % 2 === 0 ? "-right-24 md:right-[1%]" : "-left-24 md:left-[1%]";
        ...
        return (
          ...
          >
            <div className="pointer-events-none absolute inset-0 -z-10" aria-hidden="true">
              <div className="absolute left-1/2 top-[58%] h-[74%] w-[min(96%,1040px)] -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(circle_at_center,rgba(245,230,200,0.22),rgba(245,230,200,0.08)_38%,transparent_70%)]" />
              <span
                className={`absolute top-[56%] -translate-y-1/2 select-none font-semibold leading-none ${monogramPosition}`}
                style={{
                  fontSize: "clamp(15rem,28vw,30rem)",
                  color: "transparent",
                  WebkitTextStroke: "1px rgba(101,67,33,0.075)"
                }}
              >
                Ọ
              </span>
            ...
            <div className="container-luxe relative z-10">
              ...
              <div className="mx-auto grid max-w-[1040px] gap-7 md:grid-cols-[minmax(300px,390px)_minmax(420px,520px)] md:items-start md:justify-center md:gap-8 lg:gap-10">
                <div className="mx-auto w-full max-w-[390px] md:max-w-none">
                  <HeroProduct section={section} layout={layout} priority={sectionIndex === 0} />
                </div>
                <div className="mx-auto w-full max-w-[500px] md:max-w-none">
                  <SupportingGrid section={section} assets={layout.grid} priority={sectionIndex === 0} />
                </div>
              </div>
            </div>
          </section>
