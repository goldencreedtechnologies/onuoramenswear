...
export const metadata: Metadata = {
  title: {
    default: "ỌNUỌRA | Contemporary African Menswear",
    template: "%s | ỌNUỌRA"
  },
  description:
    "Contemporary African menswear designed in Nigeria with thoughtful craftsmanship and effortless wearability.",
