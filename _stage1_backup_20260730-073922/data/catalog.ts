...
type ProductInput = Omit<Product, "image" | "images" | "darkPage"> & {
...
export const products: Product[] = [
  createProduct({
    ...
    details:
      "A two-piece black stretch-tailored set with a clean V neckline, three-quarter sleeve, discreet chest pocket, tapered trouser, and the ONUORA gold signature placed as a mark of earned distinction.",
    fit:
    ...
    fabricCare:
      "Premium breathable four-way stretch suiting. Gentle cold wash with similar dark colours, reshape while damp, dry flat, and cool iron inside out. Do not bleach or tumble dry.",
    delivery:
      "Made and inspected in Nigeria. Lagos delivery is complimentary; other destinations are calculated at checkout. Tracking is issued as soon as the garment leaves the house."
  }),
  createProduct({
    slug: "ohuru",
    name: "ỌHỤRỤ",
    ...
    details:
      "A cream two-piece set defined by an open V neckline, balanced three-quarter sleeve, practical chest pocket, tapered trouser, and gold ONUORA embroidery that sits warmly against the pale cloth.",
    fit:
    ...
    fabricCare:
      "Breathable premium stretch suiting in a light cream tone. Wash gently and separately, avoid optical brighteners, dry flat away from direct heat, and press on a cool setting inside out.",
    delivery:
      "Each light-coloured garment receives an additional finish inspection before dispatch. Lagos delivery is complimentary; destination rates and timing are confirmed at checkout."
  }),
  createProduct({
    slug: "ndu",
    name: "NDỤ",
    ...
    delivery:
      "Hand-finished and quality checked in Nigeria. Complimentary delivery applies within Lagos; all other delivery charges and estimates appear before payment."
  }),
  createProduct({
    slug: "ijeoma",
    name: "IJEỌMA",
    ...
    details:
      "A blue two-piece travel-minded set with a clean V neckline, three-quarter sleeve, chest pocket, tapered trouser, and gold ONUORA insignia. The uncluttered construction makes it easy to style across destinations.",
    fit:
    ...
    delivery:
      "Dispatched in protective packaging with tracking. Lagos delivery is complimentary; outside-Lagos and international estimates are calculated from the entered destination."
  }),
  createProduct({
    slug: "aja",
    name: "AJA",
    ...
    occasion: "creative work, day events, private gatherings, and quiet luxury",
    details:
      "A forest-toned stretch set with a clean V neckline, three-quarter sleeve, functional chest pocket, precise trouser taper, and gold ONUORA mark set against the deep green.",
    fit:
    ...
    fabricCare:
      "Premium stretch suiting with a deep forest finish. Wash cold with dark colours, avoid bleach, dry flat in shade, and press from the reverse on a cool setting.",
    delivery:
      "Finished in limited runs and inspected before dispatch. Complimentary Lagos delivery and destination-based rates elsewhere are applied automatically at checkout."
  }),
  createProduct({
    slug: "nsuo",
    name: "NSỤO",
    ...
    delivery:
      "White garments receive a final handling inspection before packing. Lagos delivery is complimentary; other charges and estimated windows are displayed at checkout."
  }),
  createProduct({
    slug: "ndb1",
    name: "NDB1",
    ...
    story:
      "NDB1 brings structure to blue without making it severe. The buttoned front introduces a measured rhythm, while the cobalt tone carries calm confidence from daytime commitments into evening plans.",
    ...
    details:
      "A short-sleeve button-front stretch shirt with an open collar, coordinated tapered trouser, discreet side pockets, and gold ONUORA signatures at the chest and leg.",
    fit:
    ...
    delivery:
      "Produced in a limited colour run. Lagos delivery is complimentary; all other routes and delivery windows are confirmed from the checkout address."
  }),
  createProduct({
    slug: "ndb2",
    name: "NDB2",
    ...
    story:
      "NDB2 works in the register of earth and permanence. Brown gives the buttoned silhouette warmth and maturity, creating an assured uniform for the man who values substance over display.",
    ...
    details:
      "A brown short-sleeve button-front set with an open collar, clean placket, coordinated tapered trouser, functional pockets, and restrained gold house marks.",
    fit:
    ...
    fabricCare:
      "Premium brown stretch fabric. Gentle cold wash with similar tones, dry flat in shade, and cool iron inside out. Store away from strong direct light to preserve colour.",
    delivery:
      "Hand-finished in Nigeria and checked before dispatch. Complimentary Lagos delivery and destination-calculated service elsewhere are shown before payment."
  }),
  createProduct({
    slug: "ndb3",
    name: "NDB3",
    ...
    story:
      "NDB3 gives the buttoned edit a richer emotional register. Burgundy speaks of conviction and lineage, balanced by a crisp placket and an easy collar that keep the look contemporary.",
    ...
    details:
      "A burgundy short-sleeve button-front shirt and tapered trouser, finished with an open collar, measured placket, practical pockets, and gold ONUORA embroidery.",
    fit:
    ...
    delivery:
      "Available as a limited seasonal colour. Complimentary Lagos delivery applies; other destinations receive a calculated rate and tracked service."
  }),
  createProduct({
    slug: "ndb4",
    name: "NDB4",
    ...
    story:
      "NDB4 is the sharpest expression of the buttoned line. Onyx black removes distraction, allowing proportion, movement, and the small gold signatures to carry the entire statement.",
    ...
    details:
      "An onyx short-sleeve button-front shirt with open collar, coordinated tapered trouser, side pockets, and precisely placed gold ONUORA marks.",
    fit:
    ...
    delivery:
      "Inspected for colour and finish before dispatch. Lagos delivery is complimentary; calculated tracked delivery is available for all other supported destinations."
  }),
  createProduct({
    slug: "ndb5",
    name: "NDB5",
    ...
    story:
      "NDB5 treats purple as presence rather than ornament. The colour is regal but controlled, sharpened by the buttoned front into a look that feels expressive, assured, and entirely grown.",
    ...
    details:
      "A royal purple button-front set with an open collar, short sleeve, tapered trouser, useful pockets, and gold ONUORA embroidery that amplifies the depth of the colour.",
    fit:
    ...
    fabricCare:
      "Premium purple four-way stretch fabric. Wash separately in cold water, dry flat in shade, avoid bleach, and press inside out on a low setting.",
    delivery:
      "Made in a limited purple run and individually inspected. Complimentary Lagos delivery and calculated tracked service elsewhere appear at checkout."
  }),
  createProduct({
    slug: "nd1",
    name: "ND1",
    ...
    story:
      "ND1 lets blue move without interruption. With no button placket, the front reads as one confident plane, creating a disciplined silhouette that feels calm, direct, and easy to wear.",
    ...
    details:
      "A cobalt buttonless short-sleeve top with a clean open collar, uninterrupted front, coordinated tapered trouser, practical pockets, and gold ONUORA signatures.",
    fit:
    ...
    delivery:
      "Finished and inspected in Nigeria. Lagos delivery is complimentary; destination-aware rates and time estimates are shown at checkout."
  }),
  createProduct({
    slug: "nd2",
    name: "ND2",
    ...
    details:
      "A brown buttonless short-sleeve top with open collar and uninterrupted front, paired with a tapered stretch trouser and finished with subtle gold ONUORA marks.",
    fit:
    ...
    fabricCare:
      "Premium brown stretch suiting. Wash cold with similar colours, dry flat away from direct sun, and cool iron inside out. Do not tumble dry.",
    delivery:
      "Made in Nigeria in controlled quantities. Complimentary Lagos delivery applies; other delivery rates and tracked estimates are calculated before payment."
  }),
  createProduct({
    slug: "nd3",
    name: "ND3",
    ...
    details:
      "A burgundy buttonless top with a clean open collar, short sleeve, uninterrupted front, tapered trouser, functional pockets, and gold ONUORA embroidery.",
    fit:
    ...
    delivery:
      "Quality checked before leaving the studio. Lagos delivery is complimentary; all other supported destinations receive calculated tracked delivery."
  }),
  createProduct({
    slug: "nd4",
    name: "ND4",
    ...
    details:
      "An onyx buttonless short-sleeve top with open collar and clean front, paired with a tapered trouser and finished with measured gold ONUORA signatures.",
    fit:
    ...
    delivery:
      "Produced in a limited onyx run. Complimentary delivery applies within Lagos; tracked destination rates are confirmed at checkout elsewhere."
  }),
  createProduct({
    slug: "nd5",
    name: "ND5",
    ...
    story:
      "ND5 lets purple occupy the full silhouette. Without buttons to break the surface, the colour feels richer and more intentional, offering distinction with the ease of a modern uniform.",
    ...
    details:
      "A royal purple buttonless top with open collar, short sleeve, uninterrupted front, coordinated tapered trouser, practical pockets, and gold ONUORA marks.",
    fit:
    ...
    fabricCare:
      "Premium purple four-way stretch suiting. Wash separately in cold water, dry flat in shade, avoid bleach, and cool iron from the reverse.",
    delivery:
      "Made and inspected in Nigeria. Complimentary Lagos delivery and calculated tracked rates for other destinations are presented before payment."
  })
];
