...
export const metadata = {
  ...
  description: "ỌNUỌRA dispatch, shipping and delivery times, costs, tracking and customs information."
};
      ...
      <section className="container-luxe min-w-0 py-10 sm:py-12 md:py-16">
        ...
        <div className="mt-10 grid min-w-0 gap-9 md:mt-12 md:gap-10">
          ...
          <section className="min-w-0 border-t border-line pt-7" aria-labelledby="nigeria-delivery">
            <h2 id="nigeria-delivery" className="text-xl font-semibold">Shipping & Delivery Within Nigeria</h2>
            <p className="mt-3 max-w-3xl text-sm leading-7 text-copy-muted">Tracked shipping and delivery is available throughout Nigeria. A flat fee of ₦15,000 applies to online orders of up to six outfits. The estimated delivery window is shown during checkout.</p>
          </section>

          <section className="min-w-0 border-t border-line pt-7" aria-labelledby="international-delivery">
            <h2 id="international-delivery" className="text-xl font-semibold">International Shipping & Delivery</h2>
            <p className="mt-3 max-w-3xl text-sm leading-7 text-copy-muted">Tracked shipping and delivery is available to the United Kingdom, United States, Canada, Europe and selected destinations worldwide. International shipping is charged according to the number of outfits ordered.</p>
            <div className="mt-6 grid gap-3 sm:hidden" aria-label="International shipping and delivery rates">
          ...
          <section className="min-w-0 border-t border-line pt-7" aria-labelledby="delivery-estimates"><h2 id="delivery-estimates" className="text-xl font-semibold">Shipping & Delivery Estimates</h2><p className="mt-3 max-w-3xl text-sm leading-7 text-copy-muted">International delivery commonly takes approximately seven to eight working days after dispatch. Delivery may arrive sooner, but timing depends on destination, customs processing and courier operations. All dates are estimates rather than guarantees.</p></section>
          <section className="min-w-0 border-t border-line pt-7" aria-labelledby="grouped-rates"><h2 id="grouped-rates" className="text-xl font-semibold">Why Rates Are Grouped</h2><p className="mt-3 max-w-3xl text-sm leading-7 text-copy-muted">Shipping several outfits together usually provides better value than sending them separately. Up to two outfits can travel within the first shipping band, while larger orders move into the next parcel band.</p></section>
          <section className="min-w-0 border-t border-line pt-7" aria-labelledby="tracking"><h2 id="tracking" className="text-xl font-semibold">Tracking</h2><p className="mt-3 max-w-3xl text-sm leading-7 text-copy-muted">Once your order has been dispatched, tracking details will be sent to the email address supplied during checkout.</p></section>
          <section className="min-w-0 border-t border-line pt-7" aria-labelledby="customs"><h2 id="customs" className="text-xl font-semibold">Customs</h2><p className="mt-3 max-w-3xl text-sm leading-7 text-copy-muted">International orders may be subject to import duties, taxes or courier handling charges determined by the destination country. Where these are not collected during checkout, they remain the recipient&apos;s responsibility.</p></section>
        </div>

        <Link href="/contact?enquiry=large-order-delivery-quote" className="gold-focus mt-10 inline-flex min-h-12 max-w-full items-center justify-center border border-copy px-5 text-center text-[10px] font-semibold uppercase transition hover:bg-copy hover:text-white">Request a Shipping & Delivery Quote</Link>
      </section>
    </main>
  );
}
