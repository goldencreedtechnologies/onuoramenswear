...
export const metadata = {
  ...
  description: "How ONUORA collects, uses, stores, and protects personal information."
};
...
const sections = [
  {
    ...
    paragraphs: [
      "We collect information you provide when you create an account, place an order, request client care, join ONUORA Circle, or otherwise communicate with the house."
    ],
    bullets: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Payment card details are handled by our payment provider and are not stored in full by ONUORA."
    ]
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "ONUORA uses access controls, encrypted connections, service separation, and operational monitoring. No online system is risk-free, and customers should use a unique password and protect their devices."
    ]
  },
  {
...
export default function PrivacyPage() {
  return (
    <PolicyPage
      ...
      introduction="This policy explains the personal information ONUORA processes and the choices available to you."
